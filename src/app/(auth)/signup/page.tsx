...
export default function SignupPage() {
  ...
  async function handleSubmit(e: FormEvent) {
    ...
    // Advance status from pending_invite → pending_profile immediately
    // (covers non-email-confirmation mode; callback handles confirmation flows)
    await fetch("/api/user/init-member", { method: "POST" });
  ...
  async function handleGoogleSignIn() {
    ...
    // On success the browser navigates — no router.push needed
  }

  return (
    <div className="space-y-10">
      <div className="text-center space-y-4">
        <div className="text-label text-champagne">Join free</div>
