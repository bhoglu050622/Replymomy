...
<body>
<div class="container">
  <div class="label">ReplyMommy</div>
  <h1>You&rsquo;re in,<br><em>${name}.</em></h1>
  <p>Your profile is live. Every evening, we curate your matches — chosen for you, not the masses.</p>
  <p>Discretion is standard. Excellence is expected.</p>
  <a href="https://replymommy.com/dashboard" class="btn">Enter →</a>
  <div class="footer">
    Where desire meets discretion.<br>
    © ${new Date().getFullYear()} ReplyMommy · <a href="https://replymommy.com" style="color: rgba(201,168,76,0.5);">replymommy.com</a>
  </div>
</div>
</body>
</html>`;
